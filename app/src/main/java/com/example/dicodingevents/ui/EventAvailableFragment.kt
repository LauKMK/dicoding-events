...
import com.example.dicodingevents.databinding.FragmentEventAvailableBinding
...
class EventAvailableFragment : Fragment() {
    ...
    private fun setupRecyclerView() {
        eventAdapter = EventAvailableAdapter { eventId ->
            val action = EventAvailableFragmentDirections.actionEventAvailableFragmentToEventDetailFragment(eventId)
